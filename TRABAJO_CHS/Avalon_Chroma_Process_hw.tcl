...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL altera_up_avalon_video_alpha_blender
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file AlphaBlender.v VERILOG PATH avalon_chroma_key/AlphaBlender.v TOP_LEVEL_FILE
add_fileset_file ChromaProces.v VERILOG PATH avalon_chroma_key/ChromaProces.v

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL altera_up_avalon_video_alpha_blender
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file AlphaBlender.v VERILOG PATH avalon_chroma_key/AlphaBlender.v
add_fileset_file ChromaProces.v VERILOG PATH avalon_chroma_key/ChromaProces.v
...
add_interface_port avalon_streaming_sink avalon_streaming_sink_data data Input 30
...
set_interface_property avalon_streaming_sink_1 dataBitsPerSymbol 10
...
add_interface_port avalon_streaming_sink_1 avalon_streaming_sink_1_data data Input 30
add_interface_port avalon_streaming_sink_1 avalon_streaming_sink_1_startofpacket startofpacket Input 1
add_interface_port avalon_streaming_sink_1 avalon_streaming_sink_1_endofpacket endofpacket Input 1
add_interface_port avalon_streaming_sink_1 avalon_streaming_sink_1_ready ready Output 1
add_interface_port avalon_streaming_sink_1 avalon_streaming_sink_1_empty empty Input 2
